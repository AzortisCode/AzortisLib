...
package com.azortis.azortislib.experimental.heads;

import com.azortis.azortislib.experimental.reflection.Reflections;
...
public class CustomSkull {
    ...
    /**
     * Get a skull with a skin from the mojang skin url.
     *
     * @param url The url to get the skin from.
